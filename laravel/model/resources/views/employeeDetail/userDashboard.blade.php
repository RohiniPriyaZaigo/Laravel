...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <!-- SEARCH FORM -->
      <form class="form-inline ml-3" action="{{route('user')}}" method="post" enctype="multipart/form-data">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{asset('images/photo.jpg')}}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Welcome To User Dashboard</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-sm bg-secondary navbar-light">
                <a>
                    <h1 style = "margin-left:450px" class = "text-black">User Form</h1>
                </a>
            </nav>        
        </header>
        <form action="{{route('store')}}" method="POST" enctype="multipart/form-data" style="margin-top:50px">
          ...
          <div class="row col-6" style="margin-left:300px" ;>
            ...
            <div class="col-6">
              <input type="checkbox" name="idProof[]" value="Pan Card" {{ (is_array(old('idProof')) && in_array("Pan Card", old('idProof'))) ? 'checked' : '' }} />Pan Card
              <input type="checkbox" name="idProof[]" value="AadharCard" {{ (is_array(old('idProof')) && in_array("Aadhar Card", old('idProof'))) ? 'checked' : '' }} />Aadhar Card
              <input type="checkbox" name="idProof[]" value="VoteId" {{ (is_array(old('idProof')) && in_array("Vote Id", old('idProof'))) ? 'checked' : '' }} />Vote Id
